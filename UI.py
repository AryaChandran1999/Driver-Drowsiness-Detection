...
if selected == "Methodology":
    ...
    #                cv2.rectangle(frm,pt1=(ex,ey),pt2=(ex+ew,ey+eh), color= (255,255,255), thickness=1 )
                    
                    # preprocessing steps
    #                reye= frm[ey:ey+eh,ex:ex+ew]
